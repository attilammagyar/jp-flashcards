...
["Today it's 3 degrees probably.",                  "{今日|kyou} wa {三|san} do deshou.", ""],
["Piece of cake",                                   "asa meshi mae", ""],

["This newspaper is Ichirou's.",                    "kono shinbun wa ichirou no desu.", ""],
["How much is this bicycle?",                       "kono jitensha wa ikura desu ka.", ""],
["8:17 AM",                                         "gozen {八時|hachiji} {十七分|juu nana hun}.", ""],
["It's now 9 PM.",                                  "{今|ima} gogo {九時|kuji} desu.", ""],
["Where is (your) hometown?",                       "goshusshin wa doko desu ka.", ""],

["Where did (you) come from?",                      "doko kara kimashita.", ""],
["Ichirou eats a meal every day.",                  "ichirou wa {毎日|mainichi} gohan wo tabemasu.", ""],
["Mr. Yamada opens the door.",                      "{山田|yamada} san wa _doa_ wo akemasu.", ""],
...
["Romantic movies are not useless.",                "_romanchikku_ na eiga wa kudaranakunai desu.", ""],

["Action movies are not boring.",                   "_akushon_ eiga wa tsumaranakunai desu.", ""],
["(I) travel in France.",                           "_furansu_ wo ryokou wo shimasu.", ""],
[
...
["(I) will go to the supermarket with (my) son.",   "musuko to _suupaa_ ni ikimasu.", ""],
["Sometimes (I) go home early.",                    "{時々|tokidoki} hayaku uchi ni kaerimasu.", ""],
[
    "(My) dad will come to the college (tomorrow) morning.",
    "{父|chichi} wa asa _koreji_ ni kimasu.",
    ""
],
["(I) will return to Japan tomorrow.",              "{明日|ashita} {日本|nihon} ni kaerimasu.", ""],

["(I) get up at 6 o'clock.",                        "{六時|rokuji} ni okimasu.", ""],
["Of course (I'm) going!",                          "mochiron ikimasu.", ""],
["(I) like dogs but (I) hate that dog so much!",    "{犬|inu} wa suki desu kedo, ano {犬|inu} wa daikirai desu.", ""],
["Tonight (it's) quiet and warm.",                  "kon ya wa shizuka de atatakai desu.", ""],
["I love spring nights.",                           "haru no yoru wa daisuki desu.", ""],

["(I) drink coffee at the office every day.",       "{毎日|mainichi} jimusho de _koohii_ wo nomimasu.", ""],
[
...
["He doesn't work.",                                "{彼|kare} wa hatarakimasen.", ""],
[
    "(I) always watch television, then (I) make dinner.",
    "itsumo _terebi_ wo mimasu. sorekara bangohan wo tsukurimasu.",
    ""
],
["(I) don't watch television in the evenings.",     "yoru _terebi_ wo mimasen.", ""],
[
...
["(I) always arrive at 8 o'clock.",                 "itsumo {八時|hachiji} ni tsukimasu.", ""],
...
["I lost the game.",                                "{私|watashi} wa shiai ni makemashita.", ""],
["Are these red shoes nice?",                       "kono akai kutsu wa suteki desu ka.", ""],
["Is this blue dress beautiful?",                   "kono aoi _doresu_ wa kirei desu ka.", ""],
[
...
["This is my favorite artwork!",                    "kore wa {私|watashi} no ichiban sukina sakuhin desu.", ""],
[
...
["(I) don't talk to my neighbour.",                 "kinjo no {人|hito} to hanashimasen.", ""],
["(I) don't drink coffee for breakfast.",           "asagohan ni _koohii_ wo nomimasen.", ""],

["(I) don't clean the house.",                      "uchi wo souji wo shimasen.", ""],
["(I) don't go to work early.",                     "hayaku shigoto ni ikimasen.", ""],
["What time do (you) go home?",                     "{何時|nanji} ni uchi ni kaerimasu ka.", ""],
["What time do (you) work until?",                  "{何時|nanji} made hatarakimasu ka.", ""],
["What do (you) eat for breakfast?",                "asagohan ni {何|nani} wo tabemasu ka.", ""],

["(I) go home around 10-11 o'clock.",               "{十時|juuji}, {十一時|juuichi ji} goro kaerimasu.", ""],
...
["What time will the next train come?",             "tsugi no densha wa {何時|nanji} ni kimasu ka.", ""],
["The last train is at 11:59.",                     "shuuden wa {十一時五十九分|juuichiji gojuukyuufun} desu yo. ", ""],
["Really?!",                                        "hontou desu ka.", ""],
["It's OK. There is no problem.",                   "daijoubu desu. mondai arimasen.", ""],
["Next door there is a capsule hotel.",             "tonari ni _kapuseruhoteru_ ga arimasu.", ""],

["Oh, what was that sound (just) now?",             "are, {今|ima} no oto wa {何|nan} desu ka.", ""],
["Welcome. [Shopkeeper to customer.]",              "irasshaimase.", ""],
["(I'll have) 2 of these Christmas cards please.",  "kono _kurisumasu kaado_ wo {二|ni} mai kudasai.", ""],
["Sure. Altogether (that's) 1000 yen.",             "kashikomarimashita. zenbu de {千円|sen en} desu.", ""],
["In the evenings, I work from 7 o'clock.",         "yoru {七時|shichiji} kara shigoto wo shimasu.", ""],
...
["Is (your) father in that office over there?",     "ano jimusho ni {お父さん|otousan} ga imasu ka.", ""],
...
["every day, today, tomorrow",                      "{毎日|mainichi}, {今日|kyou}, {明日|ashita}", ""],
["every week, this week, next week",                "maishuu, konshuu, raishuu", ""],
["every month, this month, next month",             "{毎月|maitsuki, maigetsu}, {今月|kongetsu}, {来月|raigetsu}", ""],
["every year, this year, next year",                "{毎年|mainen, maitoshi}, {今年|kotoshi}, {来年|rainen}", ""],

["father [in-group, out-group]",                    "{父|chichi}, {お父さん|otousan}", ""],
["mother [in-group, out-group]",                    "{母|haha}, {お母さん|okaasan}", ""],
...
["older sister [in-group, out-group]",              "{姉|ane}, {お姉さん|oneesan}", ""],
["younger sister [in-group, out-group]",            "{妹|imouto}, {妹さん|imoutosan}", ""],
["older brother [in-group, out-group]",             "{兄|ani}, {お兄さん|oniisan}", ""],
["younger brother [in-group, out-group]",           "{弟|otouto}, {弟さん|otoutosan}", ""],
["sibling [in-group, out-group]",                   "{兄弟|kyoudai}, {ご兄弟|gokyoudai}", ""],
[
...
["(I) need money. [Money is a necessity.]",         "{お金|okane} ga hitsuyou desu.", ""],
...
["Do (you) understand English?",                    "eigo ga {分かります|wakarimasu} ka.", ""],
["Peter, (you) are very good at English.",          "_piitaa_ wa eigo ga tokui desu ne.", ""],
["She is good at cooking.",                         "{彼女|kanojo} wa ryouri ga tokui desu.", ""],
["Tomorrow (I) have an English exam.",              "{明日|ashita} eigo no shiken ga arimasu.", ""],
[
...
["How about 7 tonight?",                            "kon ya {七時|shichiji} wa dou desu ka.", ""],
["Let's go to a concert together.",                 "issho ni _konsaato_ ni ikimashou.", ""],
...
["Do (you) sell camera batteries?",                 "_kamera_ no denchi wo utteimasu ka.", ""],
...
["May (I) have 1 bottle of beer please?",           "_biiru_ wo {一本|ippon} kudasai.", ""],
["May (I) have 2 bags please?",                     "kaban wo {二つ|futatsu} kudasai.", ""],
["May (I) have 5 watches please?",                  "tokei wo {五つ|itsutsu} kudasai.", ""],
["May (I) have 4 cups of coffee please?",           "_koohii_ wo {四つ|yottsu} kudasai.", ""],
...
["On the 3rd floor (there) is a supermarket.",      "{三|san} kai ni _suupaa_ ga arimasu.", ""],
[
...
["What is on the 6th floor?",                       "rokkai ni {何|nani} ga arimasu ka.", ""],
["Who's in this office?",                           "kono jimusho ni dare ga imasu ka.", ""],
["Is there anything on the second floor?",          "{二|ni} kai ni {何|nani} ka arimasu ka.", ""],
...
["There's nothing on the second floor.",            "{二|ni} kai ni {何|nani} mo arimasen.", ""],
["There's nothing on the first floor.",             "ikkai ni {何|nani} mo arimasen.", ""],
...
["Monday, Tuesday, ... Sunday",                     "{月曜日|getsuyoubi}, {火曜日|kayoubi}, {水曜日|suiyoubi}, {木曜日|mokuyoubi}, {金曜日|kin youbi}, {土曜日|doyoubi}, {日曜日|nichiyoubi}", ""],
["356600 yen",                                      "{三十五万六千六百円|sanjuugoman rokusen roppyaku en}", ""],
[
...
["Both (my) mom and dad work in this company.",     "{母|haha} mo {父|chichi} mo kono kaisha de hatarakimasu.", ""],
[
...
["May (I) have that Sony camera please?",           "sono _soonii_ no _kamera_ wo kudasai.", ""],
...
["31000",                                           "{三万一千|san man issen}", ""],
["In which month is (your) birthday?",              "otanjoubi wa {何月|nangatsu} desu ka.", ""],

["There's someone in the house.",                   "uchi ni dare ka imasu.", ""],
["There's no one in the house.",                    "uchi ni dare mo imasen.", ""],
["Is there anything on the 3rd floor?",             "{三|san} kai ni {何|nani} ka arimasu ka.", ""],
["No, there isn't anything.",                       "iie, {何|nani} mo arimasen.", ""],
[
...
["(I'm) a little busy on Thursday.",                "{木曜日|moku youbi} chotto isogashii desu.", ""],
["Do (you) have time on Friday?",                   "{金曜日|kin youbi} wa jikan ga arimasu ka.", ""],
...
["But because (I) like you, I'm here.",             "demo, anata ga suki desu kara, {私|watashi} wa koko ni imasu.", ""],
["I'll teach you.",                                 "{私|watashi} ga anata ni oshiemasu.", ""],
["(This) is (my) first time at a sports game.",     "_supootsu_ no shiai wa hajimete desu.", ""],
...
["Where's the hotel? Do (you) know?",               "_hoteru_ wa doko ni arimasu ka. gozonji desu ka.", ""],
["The hotel is behind the art gallery.",            "_hoteru_ wa bijutsukan no ushiro ni arimasu.", ""],
[
...
["(I) want to drink a beer.",                       "_biiru_ wo nomitai desu.", ""],
["Last night (I) didn't drink (any) beer at all.",  "yuube _biiru_ wo zenzen nomimasen deshita.", ""],

["Last week (I) watched a movie with Ms. Natsuko.", "senshuu natsuko san to eiga wo mimashita.", ""],
["The bank is next door to the restaurant.",        "ginkou wa _resutoran_ no tonari ni arimasu.", ""],
["The bus stop is to the side of the bank.",        "_basu_ tei wa ginkou no yoko ni arimasu.", ""],
[
...
["The hotel is opposite the post office.",          "_hoteru_ wa yuubinkyoku no mukaigawa ni arimasu.", ""],

["The restaurant is above the museum.",             "_resutoran_ wa hakubutsukan no {上|ue} ni arimasu.", ""],
["My camera is in that bag.",                       "{私|watashi} no _kamera_ wa sono kaban no {中|naka} ni arimasu.", ""],
["Ms. Natsuko is by me.",                           "natsuko san wa {私|watashi} no soba ni imasu.", ""],
[
...
["My business card is in (my) bag.",                "{私|watashi} no meishi wa kaban no {中|naka} ni arimasu.", ""],
...
["What is opposite the post office?",               "yuubinkyoku no mukaigawa ni {何|nani} ga arimasu ka.", ""],
...
["Please turn left at the first traffic lights.",   "{一つ|hitotsu} me no shingou wo hidari ni magatte kudasai.", ""],
...
["Turn right at the second traffic lights please.", "{二つ|futatsu} me no shingou wo migi ni magatte kudasai.", ""],
[
...
["(At) what time shall (we) meet?",                 "{何時|nan ji} ni aimashou ka.", ""],
["What shall (we) do?",                             "{何|nani} wo shimashou ka.", ""],
[
...
["25 past 1 o'clock",                               "{一時二十五分|ichi ji ni juu go fun}", ""],
["30 past 1 o'clock, half past 1 o'clock",          "{一持三十分|ichi ji san juppun}, {一時|ichi ji} han", ""],
["45 past 1 o'clock, quarter to 2 o'clock",         "{一時四十五分|ichi ji yon juu go fun}, {二時十五分|ni ji juu go fun} mae", ""],
["50 past 1 o'clock, 10 to 2 o'clock",              "{一時五十分|ichi ji go juppun}, {二時十分|ni ji juppun} mae", ""],
["Let's meet in front of the museum!",              "hakubutsukan no mae de aimashou.", ""],

["What day is it today?",                           "{今日|kyou} wa {何|nan} no {日|hi} desu ka.", ""],
["Is it only that?",                                "sore dake desu ka.", ""],
["(I) will ask one more time.",                     "mou ichi do kikimasu.", ""],
["Do you understand Chinese?",                      "{中国語|chuugokugo} wa {分かります|wakarimasu} ka.", ""],
["What's the opposite of divorce?",                 "rikon no hantai wa {何|nan} desu ka.", ""],
...
["That person is famous you know!",                 "ano {人|hito} wa yuumei desu yo.", ""],

["That person is beautiful.",                       "ano {人|hito} wa utsukushii desu.", ""],
["That person is cheerful.",                        "ano {人|hito} wa {明るい|akarui} desu.", ""],
["That person is kind.",                            "ano {人|hito} wa yasashii desu.", ""],
["That person is quiet.",                           "ano {人|hito} wa otonashii desu.", ""],
["That person is embarrassed.",                     "ano {人|hito} wa hazukashii desu.", ""],

["That person is nice.",                            "ano {人|hito} wa ii desu.", ""],
["How was it?",                                     "dou deshita ka.", ""],
["How was (your) date with Ms. Natsuko?",           "natsuko san to _deeto_ wa dou deshita ka.", ""],
...
["Next year I hope to go to Japan again.",          "{来年|rainen} mata {日本|nihon} ni ikitai to omoimasu.", ""],
["I have a headache.",                              "{私|watashi} wa atama ga itai desu.", ""],
["(My) mother is tall (and) has big eyes.",         "{母|haha} wa se ga takakute me ga {大きい|ookii} desu.", ""],
...
["Ms. Miki is bad at bowling.",                     "{三木|miki} san wa _booringu_ ga heta desu.", ""],
["eyes, big, small, round",                         "me, {大きい|ookii}, {小さい|chiisai}, marui", ""],
["back/height, high/tall, low/short, average",      "se, takai, hikui, futsuu (na)", ""],
["nose, tall/big, small, wide",                     "hana, takai, {小さい|chiisai}, {大きい|ookii}", ""],
...
["I am tall (with) blue eyes and blonde hair.",     "{私|watashi} wa se ga takakute, me ga aokute, kami ga kinpatsu desu.", ""],
[
...
["I think he's famous.",                            "{彼|kare} wa yuumei da to omoimasu.", ""],
...
["What's wrong with him? What's wrong?",            "{彼|kare} wa dou shita no desu ka. dou shita n desu ka.", ""],
...
["(I) gained 3 kilos over Christmas.",              "_kurisumasu_ ni {三|san} _kiro_ futorimashita.", ""],
["I took a bus.",                                   "{私|watashi} wa _basu_ ni norimashita.", ""],
...
["May (I) have 2 tickets for Osaka please?",        "ousaka yuki no kippu wo {二|ni} mai kudasai.", ""],
...
["Person/someone, people", "{人|_jin_, _nin_, hito}, {人々|hitobito}", ""],
[
    "1, one-by-one (people)",
    "{一|_ichi_, _itsu_, hito(tsu), hito}, {一人一人|hitorihitori}",
    ""
],
[
    "2, (both) 2 people, 2 days/2nd day of month",
    "{二|_ni_, futa(tsu), futa}, {二人tomo|futaritomo}, {二日|futsuka}",
    ""
],
["3, 3 days/3rd day of month", "{三|_san_, mi, みっ(つ)}, {三日|mikka}", ""],
[
    "Sun/day, 1 day, 1st day of month",
    "{日|_nichi_, _jitsu_, hi, ka}, {一日|ichinichi, ichijitsu}, {一日|tsuitachi}",
    ""
],

[
    "4, 4 people, 4 days/4th day of month, 14 days/14th day of month",
    "{四|_shi_, よっ(つ), yotsu, yo, yon}, {四人|yonin}, {四日|yokka}, {十四日|juuyokka}",
    ""
],
["5, 5 people, 5 days/5th day of month", "{五|_go_, itsu(tsu), itsu}, {五人|gonin}, {五日|itsuka}", ""],
["6, 6 days/6th day of month", "{六|_roku_, むっ(つ), mu(tsu), mu}, {六日|muika}", ""],
[
    "7, 7 people, 7 days/7th day of month",
    "{七|_shichi_, nana(tsu), nana}, {七人|shichinin}, {七日|nanoka}",
    ""
],
[
    "8, 8 people, 8 days/8th day of month, 18 days/18th day of month",
    "{八|_hachi_, やっ(つ), ya(tsu), ya}, {八人|hachinin}, {八日|youka}, {十八日|juuhachinichi}",
    ""
],

[
    "9, 9 people, 9 days/9th day of month",
    "{九|_kyuu_, _ku_, kokono(tsu), kokono}, {九人|kyuunin}, {九日|kokonoka}",
    ""
],
[
    "10, 10 people, 10 days/10th day of month, 20 days/20th day of month",
    "{十|_juu_, _ji_, tou, to}, {十人|juunin}, {十日|touka}, {二十日|hatsuka}",
    ""
],
["Circle (Yen), round", "{円|_en_}, {円|maru(i)}", ""],
["100", "{百|_hyaku_}", ""],
[
    "Thousand, 1000, 3000, 8000",
    "{千|_sen_, chi}, {一千|issen}, {三千|sanzen}, {八千|hassen}",
    ""
],

["10000, countless/all, 1 million", "{万|_man_}, {万|_ban_}, {百万|hyakuman}", ""],
[
    "Moon/month, month, January, 1 month",
    "{月|_getsu_, tsuki}, {月|_gatsu_}, {一月|ichigatsu}, {一月|hitotsuki}",
    ""
],
[
    "Light, light/next, bright",
    "{明|_mei_, a(kari)}, {明|_myou_}, {明rui|akarui}, {明日|ashita, asu,myounichi}",
    ""
],
["Weekday", "{曜|_you_}", ""],
["Fire, spark", "{火|_ka_, hi}, {火花|hibana}", ""],
["Water", "{水|_sui_, mizu}", ""],

["Tree/wood", "{木|_boku_, _moku_, ki}", ""],
["Gold/metal, money", "{金|_kin_, _kon_}, {金|kane}", ""],
["Soil/ground", "{土|_do_, _to_, tsuchi}", ""],
["Book/origin, origin, Japan", "{本|_hon_}, {本|moto}, {日本|nihon, nippon}", ""],
["Big/great/wide, big", "{大|_dai_, _tai_, oo(kii), oo}, {大kii|ookii}", ""],

["Small/tiny", "{小|_shou_, chii(sai), ko, o}", ""],
["center/inside, center/inside/middle", "{中|_chuu_}, {中|naka}", ""],
["Style/appearance/mode, wind/breeze", "{風|_fuu_, _fu_}, {風|kaze}", ""],
["Rain, heavy rain, light rain", "{雨|_U_, ame}, {大雨|ooame}, {小雨|kosame}", ""]
